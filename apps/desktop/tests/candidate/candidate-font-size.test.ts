...
test("invalid or missing sizes use Windows baseline defaults without emitting unsafe CSS", () => {
  for (const value of [undefined, null, "20", "20px;color:red", NaN, Infinity, -1, 11, 33, 16.5]) {
