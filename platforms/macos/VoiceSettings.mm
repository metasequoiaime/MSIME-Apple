...
@implementation MSIMEVoiceSettings {
    ...
    NSTextField *_doubaoBoostingTable;
    NSTextField *_doubaoBoostingTable;
    NSButton *_hotkey, *_muteAudio, *_soundEnabled, *_holdSpace, *_rightAlt, *_streamInline;
...
- (void)showAndActivate {
    if (!self.window) {
        ...
        _asrModel = [NSTextField textFieldWithString:@""]; _asrModel.placeholderString = @"ASR 模型（可选）"; _doubaoBoostingTable = [NSTextField textFieldWithString:@""]; _doubaoBoostingTable = [NSTextField textFieldWithString:@""];
        ...
        NSGridView *grid = [NSGridView gridViewWithViews:@[@[[NSTextField labelWithString:@"识别语言"], _language], @[[NSTextField labelWithString:@"ASR 提供商"], _provider], @[[NSTextField labelWithString:@"ASR 接口"], _endpoint], @[[NSTextField labelWithString:@"ASR Token"], _token], @[[NSTextField labelWithString:@"语音快捷键"], _hotkey], @[[NSTextField labelWithString:@"按键方式"], _holdSpace], @[[NSTextField labelWithString:@"右 Option"], _rightAlt], @[[NSTextField labelWithString:@"提示音"], _soundEnabled], @[[NSTextField labelWithString:@"系统音频"], _muteAudio], @[[NSTextField labelWithString:@"中间结果"], _streamInline], @[[NSTextField labelWithString:@"文本润色"], _polish], @[[NSTextField labelWithString:@"润色提供商"], _polishProvider], @[[NSTextField labelWithString:@"润色模型"], _model], @[[NSTextField labelWithString:@"权限"], _status], @[[NSTextField labelWithString:@""], permission]]];
        [grid addRowWithViews:@[[NSTextField labelWithString:@"ASR 模型"], _asrModel]]; [grid addRowWithViews:@[[NSTextField labelWithString:@"Doubao 词表"], _doubaoBoostingTable]];
        [grid addRowWithViews:@[[NSTextField labelWithString:@"Doubao 词表"], _doubaoBoostingTable]];
        _asrModel.stringValue = [defaults stringForKey:@"MSIMEClientVoiceASRModel"] ?: @""; _doubaoBoostingTable.stringValue = [defaults stringForKey:@"MSIMEClientVoiceDoubaoBoostingTableID"] ?: @""; _doubaoBoostingTable.stringValue = [defaults stringForKey:@"MSIMEClientVoiceDoubaoBoostingTableID"] ?: @"";
...
- (void)voiceOptionsChanged:(id)sender { (void)sender; NSUserDefaults *d=NSUserDefaults.standardUserDefaults; NSArray *asr=@[@"doubao",@"openai",@"siliconflow",@"groq"], *polish=@[@"deepseek",@"openai",@"siliconflow",@"groq"]; [d setObject:asr[_provider.indexOfSelectedItem] forKey:@"MSIMEClientVoiceASRProvider"]; [d setObject:_endpoint.stringValue forKey:@"MSIMEClientVoiceASREndpoint"]; [d setObject:_token.stringValue forKey:@"MSIMEClientVoiceASRToken"]; [d setBool:_hotkey.state==NSControlStateValueOn forKey:@"MSIMEClientVoiceHotkeyCtrlF9"]; [d setBool:_holdSpace.state==NSControlStateValueOn forKey:@"MSIMEClientVoiceHotkeyHoldSpace"]; [d setBool:_rightAlt.state==NSControlStateValueOn forKey:@"MSIMEClientVoiceHotkeyRightAlt"]; [d setBool:_soundEnabled.state==NSControlStateValueOn forKey:@"MSIMEClientVoiceSoundEnabled"]; [d setBool:_muteAudio.state==NSControlStateValueOn forKey:@"MSIMEClientVoiceMuteSystemAudio"]; [d setBool:_streamInline.state==NSControlStateValueOn forKey:@"MSIMEClientVoiceStreamInlinePreedit"]; [d setBool:_polish.state==NSControlStateValueOn forKey:@"MSIMEClientVoicePolish"]; [d setObject:polish[_polishProvider.indexOfSelectedItem] forKey:@"MSIMEClientVoicePolishProvider"]; [d setObject:_model.stringValue forKey:@"MSIMEClientVoicePolishModel"]; [d setObject:_doubaoBoostingTable.stringValue forKey:@"MSIMEClientVoiceDoubaoBoostingTableID"]; [d setObject:_doubaoBoostingTable.stringValue forKey:@"MSIMEClientVoiceDoubaoBoostingTableID"]; [[NSNotificationCenter defaultCenter] postNotificationName:MSIMEVoiceSettingsDidChangeNotification object:self]; }
@end
