...
@implementation MSIMEVoiceSettings {
    ...
    NSButton *_hotkey, *_muteAudio, *_soundEnabled, *_holdSpace, *_rightAlt, *_streamInline, *_doubaoITN, *_doubaoPunc, *_doubaoDDC;
...
- (void)showAndActivate {
    if (!self.window) {
        ...
        _holdSpace = [NSButton checkboxWithTitle:@"按住空格进行语音输入" target:self action:@selector(voiceOptionsChanged:)]; _holdSpace.state = [defaults objectForKey:@"MSIMEClientVoiceHotkeyHoldSpace"] == nil || [defaults boolForKey:@"MSIMEClientVoiceHotkeyHoldSpace"] ? NSControlStateValueOn : NSControlStateValueOff;
        _rightAlt = [NSButton checkboxWithTitle:@"启用右 Option 语音快捷键" target:self action:@selector(voiceOptionsChanged:)]; _rightAlt.state = [defaults boolForKey:@"MSIMEClientVoiceHotkeyRightAlt"] ? NSControlStateValueOn : NSControlStateValueOff;
        ...
        _doubaoITN = [NSButton checkboxWithTitle:@"豆包 ITN" target:self action:@selector(voiceOptionsChanged:)]; _doubaoITN.state = [defaults objectForKey:@"MSIMEClientVoiceDoubaoITN"] == nil || [defaults boolForKey:@"MSIMEClientVoiceDoubaoITN"] ? NSControlStateValueOn : NSControlStateValueOff;
        _doubaoPunc = [NSButton checkboxWithTitle:@"豆包标点" target:self action:@selector(voiceOptionsChanged:)]; _doubaoPunc.state = [defaults objectForKey:@"MSIMEClientVoiceDoubaoPunc"] == nil || [defaults boolForKey:@"MSIMEClientVoiceDoubaoPunc"] ? NSControlStateValueOn : NSControlStateValueOff;
        _doubaoDDC = [NSButton checkboxWithTitle:@"豆包 DDC" target:self action:@selector(voiceOptionsChanged:)]; _doubaoDDC.state = [defaults boolForKey:@"MSIMEClientVoiceDoubaoDDC"] ? NSControlStateValueOn : NSControlStateValueOff;
        ...
        NSGridView *grid = [NSGridView gridViewWithViews:@[@[[NSTextField labelWithString:@"识别语言"], _language], @[[NSTextField labelWithString:@"ASR 提供商"], _provider], @[[NSTextField labelWithString:@"ASR 接口"], _endpoint], @[[NSTextField labelWithString:@"ASR Token"], _token], @[[NSTextField labelWithString:@"语音快捷键"], _hotkey], @[[NSTextField labelWithString:@"按键方式"], _holdSpace], @[[NSTextField labelWithString:@"右 Option"], _rightAlt], @[[NSTextField labelWithString:@"提示音"], _soundEnabled], @[[NSTextField labelWithString:@"系统音频"], _muteAudio], @[[NSTextField labelWithString:@"中间结果"], _streamInline], @[[NSTextField labelWithString:@"豆包选项"], _doubaoITN], @[[NSTextField labelWithString:@""], _doubaoPunc], @[[NSTextField labelWithString:@""], _doubaoDDC], @[[NSTextField labelWithString:@"文本润色"], _polish], @[[NSTextField labelWithString:@"润色提供商"], _polishProvider], @[[NSTextField labelWithString:@"润色模型"], _model], @[[NSTextField labelWithString:@"权限"], _status], @[[NSTextField labelWithString:@""], permission]]];
