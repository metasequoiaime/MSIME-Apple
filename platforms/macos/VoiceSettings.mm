...
@implementation MSIMEVoiceSettings {
    ...
    NSTextField *_doubaoBoostingTable, *_doubaoAppKey, *_doubaoResourceID;
...
- (void)showAndActivate {
    if (!self.window) {
        ...
        _token = [[NSSecureTextField alloc] initWithFrame:NSZeroRect]; _token.placeholderString = @"ASR Token（仅保存在本机）"; _polishToken = [[NSSecureTextField alloc] initWithFrame:NSZeroRect]; _polishToken.placeholderString = @"整理 Token（仅保存在本机）"; _polishToken = [[NSSecureTextField alloc] initWithFrame:NSZeroRect]; _polishToken.placeholderString = @"整理 Token（仅保存在本机）";
        ...
        _token.stringValue = [defaults stringForKey:@"MSIMEClientVoiceASRToken"] ?: @""; _polishToken.stringValue = [defaults stringForKey:@"MSIMEClientVoicePolishToken"] ?: @""; _polishToken.stringValue = [defaults stringForKey:@"MSIMEClientVoicePolishToken"] ?: @"";
        ...
        _endpoint.target = self; _endpoint.action = @selector(voiceOptionsChanged:); _token.target = self; _token.action = @selector(voiceOptionsChanged:); _polishToken.target = self; _polishToken.action = @selector(voiceOptionsChanged:); _polishToken.target = self; _polishToken.action = @selector(voiceOptionsChanged:); _asrModel.target = self; _asrModel.action = @selector(asrModelChanged:);
        ...
        NSGridView *grid = [NSGridView gridViewWithViews:@[@[[NSTextField labelWithString:@"识别语言"], _language], @[[NSTextField labelWithString:@"ASR 提供商"], _provider], @[[NSTextField labelWithString:@"ASR 接口"], _endpoint], @[[NSTextField labelWithString:@"ASR Token"], _token], @[[NSTextField labelWithString:@"语音快捷键"], _hotkey], @[[NSTextField labelWithString:@"按键方式"], _holdSpace], @[[NSTextField labelWithString:@"右 Option"], _rightAlt], @[[NSTextField labelWithString:@"Control+Command"], _ctrlCommand], @[[NSTextField labelWithString:@"右 Control+Option"], _ctrlOption], @[[NSTextField labelWithString:@"提示音"], _soundEnabled], @[[NSTextField labelWithString:@"系统音频"], _muteAudio], @[[NSTextField labelWithString:@"中间结果"], _streamInline], @[[NSTextField labelWithString:@"文本润色"], _polish], @[[NSTextField labelWithString:@"润色提供商"], _polishProvider], @[[NSTextField labelWithString:@"润色模型"], _model], @[[NSTextField labelWithString:@"整理 Token"], _polishToken], @[[NSTextField labelWithString:@"整理 Token"], _polishToken], @[[NSTextField labelWithString:@"权限"], _status], @[[NSTextField labelWithString:@""], permission]]];
