...
- (void)showAndActivate {
    if (!self.window) {
        ...
        NSGridView *grid = [NSGridView gridViewWithViews:@[@[[NSTextField labelWithString:@"识别语言"], _language], @[[NSTextField labelWithString:@"ASR 提供商"], _provider], @[[NSTextField labelWithString:@"ASR 接口"], _endpoint], @[[NSTextField labelWithString:@"ASR Token"], _token], @[[NSTextField labelWithString:@"语音快捷键"], _hotkey], @[[NSTextField labelWithString:@"按键方式"], _holdSpace], @[[NSTextField labelWithString:@"右 Option"], _rightAlt], @[[NSTextField labelWithString:@"Control+Command"], _ctrlCommand], @[[NSTextField labelWithString:@"右 Control+Option"], _ctrlOption], @[[NSTextField labelWithString:@"提示音"], _soundEnabled], @[[NSTextField labelWithString:@"系统音频"], _muteAudio], @[[NSTextField labelWithString:@"中间结果"], _streamInline], @[[NSTextField labelWithString:@"文本润色"], _polish], @[[NSTextField labelWithString:@"润色提供商"], _polishProvider], @[[NSTextField labelWithString:@"润色模型"], _model], @[[NSTextField labelWithString:@"整理地址"], _polishEndpoint], @[[NSTextField labelWithString:@"整理地址"], _polishEndpoint], @[[NSTextField labelWithString:@"整理提示词"], _polishPrompt], @[[NSTextField labelWithString:@"自定义整理 1"], _polishCustom1], @[[NSTextField labelWithString:@"自定义整理 2"], _polishCustom2], @[[NSTextField labelWithString:@"自定义整理 3"], _polishCustom3], @[[NSTextField labelWithString:@"权限"], _status], @[[NSTextField labelWithString:@""], permission]]];
