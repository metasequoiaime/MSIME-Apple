...
@implementation MSIMEVoiceSettings {
    ...
    NSTextField *_doubaoBoostingTable, *_doubaoAppKey, *_doubaoResourceID, *_polishPrompt;
...
- (void)showAndActivate {
    if (!self.window) {
        ...
        _model = [NSTextField textFieldWithString:@""]; _model.placeholderString = @"留空使用提供商默认模型"; _polishPrompt = [NSTextField textFieldWithString:@""]; _polishPrompt.placeholderString = @"整理提示词（可选）";
        ...
        _model.stringValue = [defaults stringForKey:@"MSIMEClientVoicePolishModel"] ?: @""; _polishPrompt.stringValue = [defaults stringForKey:@"MSIMEClientVoicePolishPrompt"] ?: @"";
        ...
        NSGridView *grid = [NSGridView gridViewWithViews:@[@[[NSTextField labelWithString:@"识别语言"], _language], @[[NSTextField labelWithString:@"ASR 提供商"], _provider], @[[NSTextField labelWithString:@"ASR 接口"], _endpoint], @[[NSTextField labelWithString:@"ASR Token"], _token], @[[NSTextField labelWithString:@"语音快捷键"], _hotkey], @[[NSTextField labelWithString:@"按键方式"], _holdSpace], @[[NSTextField labelWithString:@"右 Option"], _rightAlt], @[[NSTextField labelWithString:@"Control+Command"], _ctrlCommand], @[[NSTextField labelWithString:@"右 Control+Option"], _ctrlOption], @[[NSTextField labelWithString:@"提示音"], _soundEnabled], @[[NSTextField labelWithString:@"系统音频"], _muteAudio], @[[NSTextField labelWithString:@"中间结果"], _streamInline], @[[NSTextField labelWithString:@"文本润色"], _polish], @[[NSTextField labelWithString:@"润色提供商"], _polishProvider], @[[NSTextField labelWithString:@"润色模型"], _model], @[[NSTextField labelWithString:@"整理提示词"], _polishPrompt], @[[NSTextField labelWithString:@"权限"], _status], @[[NSTextField labelWithString:@""], permission]]];
