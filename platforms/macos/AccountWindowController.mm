...
- (void)showForAccountID:(NSString *)accountID {
    ...
    if (!self.window) {
        self.window = [[NSWindow alloc] initWithContentRect:NSMakeRect(0, 0, 420, 220)
    ...
    NSView *view = [[NSView alloc] initWithFrame:NSMakeRect(0, 0, 420, 220)]; [view addSubview:label]; [view addSubview:login]; [view addSubview:settings]; self.window.contentView = view;
