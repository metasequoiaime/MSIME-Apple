...
FOUNDATION_EXPORT void MSIMERestoreCloudDictionarySnapshot(NSURL *file, long long revision, NSString *expectedSHA256, NSString *bearerToken, MSIMECloudDictionaryCompletion completion);
