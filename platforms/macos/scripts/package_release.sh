...
pkgbuild --component "$packaged_bundle" --identifier app.msime.inputmethod.MetasequoiaIME.pkg --version "$build_number" --scripts "$pkg_scripts" --install-location "Library/Input Methods" "$component_package"
