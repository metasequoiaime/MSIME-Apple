...
javac --release 17 -Xlint:all -Werror -cp "$android_jar" -d "$build_dir/classes" platforms/android/tests/device/EditorActivity.java platforms/android/tests/device/DeviceSmoke.java platforms/android/tests/device/CandidatePanelDeviceSmoke.java platforms/android/tests/device/MoreToolsDeviceSmoke.java platforms/android/tests/device/HandwritingDeviceSmoke.java platforms/android/tests/device/PreferencesDeviceSmoke.java platforms/android/tests/device/FuzzyPinyinDeviceSmoke.java platforms/android/tests/device/SettingsDeviceSmoke.java platforms/android/tests/device/SettingsLifecycleSmoke.java platforms/android/tests/device/TypingStatisticsDeviceSmoke.java platforms/android/java/app/msime/client/WindowLayout.java
