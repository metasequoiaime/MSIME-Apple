...
javac --release 17 -Xlint:all -Werror -cp "$android_jar" -d "$build_dir/classes" platforms/android/tests/device/EditorActivity.java platforms/android/tests/device/DeviceSmoke.java platforms/android/java/app/msime/client/WindowLayout.java
