...
for method in prepareHostRaw snapshotVersionRaw snapshotPrepareRaw snapshotDiscardRaw snapshotActivateRaw loadPreferencesRaw savePreferencesRaw createRaw characterRaw punctuationWithContextRaw setNineKeyModeRaw setChinesePunctuationRaw setCharacterWidthRaw selectEdgeRaw doubaoStartFrameRaw doubaoAudioFrameRaw doubaoDecodeFrameRaw chooseNineKeySpellingRaw updatePreferencesRaw pinCandidateRaw fixCandidatePositionRaw clearCandidatePositionRaw removeCandidateRaw emojiCatalogRaw candidateGlossesRaw applyTranslationsRaw onlineQueryRaw cloudRequestUrlRaw aiRequestForQueryRaw applyCloudResponseRaw applyOnlineCandidatesRaw destroyRaw; do
