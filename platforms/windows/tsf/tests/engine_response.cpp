...
int main() {
  ...
  const std::string response =
      R"({"ok":true,"value":{"handled":true,"has_commit":true,"commit":"你","diagnostic":"","view":{"preedit":"ni","editing_text":"ni","caret":1,"candidates":[{"id":{"generation":7,"index":12},"text":"你","highlighted":true}]}}})";
