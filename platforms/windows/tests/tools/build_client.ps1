...
try {
    ...
    $fetch = $global:ClientBuildCalls[21]
    ...
    $stage = $global:ClientBuildCalls[22].Values
    if ($global:ClientBuildCalls[22].Name -ne 'cmake' -or $stage[0] -ne '-E' -or $stage[1] -ne 'copy_if_different' -or
