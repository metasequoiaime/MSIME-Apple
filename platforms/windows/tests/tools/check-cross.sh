...
for arch in x86_64 i686; do
  ...
  for source in InputQueue.cpp SessionPump.cpp SessionWorkers.cpp SessionController.cpp PreferenceMonitor.cpp WindowsServer.cpp platforms/windows/tests/runtime/server_smoke.cpp platforms/windows/tests/input/input_queue.cpp platforms/windows/tests/runtime/session_pump.cpp platforms/windows/tests/runtime/session_workers.cpp platforms/windows/tests/core/preference_monitor.cpp; do
