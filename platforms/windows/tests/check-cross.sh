#!/usr/bin/env bash
# Compilation only: this does not link or execute a Windows program.
set -euo pipefail
...
echo "Windows x86/x64 Server adapter, test source and upstream wire contract compiled; no Windows runtime verified"
