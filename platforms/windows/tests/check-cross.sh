...
for arch in x86_64 i686; do
  ...
  "$compiler" -std=c++17 -Wall -Wextra -Werror -Iplatforms/windows -Ivendor/MSIME-Engine/contracts \
    ...
    platforms/windows/PipeListener.cpp platforms/windows/PipeRegistry.cpp platforms/windows/PipeIntake.cpp platforms/windows/ReplyCodec.cpp platforms/windows/tests/pipe_io.cpp -ladvapi32 -o "$output/pipe-io.exe"
  "$compiler" -std=c++17 -Wall -Wextra -Werror -Iplatforms/windows -Ivendor/MSIME-Engine/contracts \
