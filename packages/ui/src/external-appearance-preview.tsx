...
function LoadedPreview({ skin, preferences, readImage, helpcode, theme }: {
  ...
  const geometry = {
    ...
    ...candidateTextStyle(preferences.candidate_text_color, preferences.candidate_number_color, preferences.candidate_accent_color, preferences.candidate_selected_color, preferences.candidate_hover_color),
