...
with sync_playwright() as playwright:
    ...
    print({"appearanceDraftPreview": True, "fontSize": True, "skinPalette": True, "reload": True, "willowHiddenPreedit": True, "externalPalette": True, "externalDecoration": True, "cleanup": True})
    browser.close()
