...
#
# Each special check as name=file-that-runs-it. The first three run inline just below; the Playwright pair needs a served fixture plus --url and --csp, which packages/ui/UPSTREAM.md describes; android-json-null-reads runs inside "android host java".
